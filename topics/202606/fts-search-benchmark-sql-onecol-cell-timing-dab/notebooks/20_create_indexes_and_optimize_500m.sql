...
OPTIMIZE fts_text_500m_scan;
OPTIMIZE fts_text_500m_ngram;
OPTIMIZE fts_text_500m_split;
...
WHERE table_catalog = :catalog
  ...
  AND table_name IN ('fts_text_500m_scan','fts_text_500m_ngram','fts_text_500m_split')
GROUP BY table_name;
...
WHERE run_id = :run_id AND scale_label = '500m'
