...
This folder defines all source code for the 'tests_dlt' pipeline:
...
* Take a look at the sample under "sample_trips_tests_dlt.sql" to get familiar with the syntax.
